...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nombre', models.CharField(max_length=100, verbose_name='Nombre del ttipo de equipo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problema', models.CharField(max_length=200, verbose_name='Descripcion del problema')),
                ('contraseña', models.CharField(max_length=100, verbose_name='Contraseña del equipo')),
                ...
                ('trabajosRealizados', models.CharField(max_length=200, verbose_name='Trabajos realizados sobre el equipo')),
                ('ubicacion', models.CharField(max_length=200, verbose_name='Ubicacion o Estante en el que se encuentra')),
                ...
                ('tipoEquipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Servicios.TipoEquipo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=100, verbose_name='Estado del Repuesto')),
