    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.CharField(blank=True, choices=[('Movistar', 'Movistar'), ('Claro', 'Claro'), ('Personal', 'Personal'), ('Tuenti', 'Tuenti'), ('Otro', 'Otro')], max_length=50, null=True, verbose_name='Empresa')),
                ('borrado', models.BooleanField(default=False, verbose_name='borrado')),
            ],
        ),
        migrations.CreateModel(
